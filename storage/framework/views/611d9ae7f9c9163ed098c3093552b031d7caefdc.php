        ...
        <div class="col col-lg-10 col-xl-9 col-xxl-8 p-4 product-detail rounded-4">
            <div class="row">
                <div class="col-12 col-sm-5 col-md-4 d-flex justify-content-start">
                    <img class="img-fluid cloth-detail rounded-4"src="<?php echo e(asset('/storage/images/' . $product->image)); ?>" alt="Card image cap">
                </div>
                ...
                <div class="col-12 col-sm col-md col-lg-3 ms-2 d-flex flex-column align-self-center">
                    ...
                    <form action="<?php echo e(route('editCart', $product->id)); ?>" method="POST">
                        <?php echo e(method_field('PUT')); ?>

                        <?php echo csrf_field(); ?>
                        <div class="d-flex">
                            <label class="qty">Quantity : </label>
                            <input type="text" name="quantity" value="<?php echo e($product->pivot->quantity); ?>"
...
<?php echo $__env->make('templates.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mike\OneDrive\Desktop\MaiBoutique\MaiBoutique\resources\views/editCart.blade.php ENDPATH**/ ?>