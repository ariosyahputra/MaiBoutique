            ...
            <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 profile d-flex flex-column py-3 rounded-4">
                ...
                <div class="mt-auto">
                    <div class="d-flex justify-content-center gap-4">
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('editPassword')); ?>" class="btn btn-sm btn-outline-primary rounded-3 px-2">Edit Password</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('templates.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mike\OneDrive\Desktop\sem 5\WP\Lab\MaiBoutique\MaiBoutique\resources\views/profile.blade.php ENDPATH**/ ?>