...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-center my-5">
        <div class="col-9 col-sm-7 col-md-5 col-lg-4 col-xl-3 p-4 rounded-3 d-flex flex-column form-sign-up mb-5">
...
unset($__errorArgs, $__bag); ?>" id="floatingInput"
                        placeholder="name@example.com" autofocus value=<?php echo e(old('username')); ?>>
...
unset($__errorArgs, $__bag); ?>" id="floatingInput"
                        placeholder="name@example.com" autofocus value=<?php echo e(old('phone_number')); ?>>
...
unset($__errorArgs, $__bag); ?>" id="floatingInput"
                        placeholder="name@example.com" autofocus value=<?php echo e(old('address')); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="my-3 to-login text-center">
                    ...
                    <a href="<?php echo e(route('login')); ?>">SignIn Here</a>
                </div>
...
<?php echo $__env->make('templates.landingTemplate', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mike\OneDrive\Desktop\project\resources\views/auth/register.blade.php ENDPATH**/ ?>